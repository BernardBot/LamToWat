...
style = LanguageDef
        ...
        , opLetter        = oneOf ":!#%&*+./<=>?@\\^|-~"
        , reservedOpNames = ["="]
        , reservedNames   = ["module","memory","global","mut","i32.const","table","funcref","elem","type","func"
                            ,"param","result","local","offset","global.get","global.set","local.get","local.set"
                            ,"export","i32.add","i32.load","i32.store","return_call_indirect"]
        , caseSensitive   = True
        }
